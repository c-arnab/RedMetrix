            ...
            var options = new ConfigurationOptions
                {
                    ...
                    EndPoints = { _configuration.GetSection("RedisOptions:EndPoints").Value },
                    Password = _configuration.GetSection("RedisOptions:Password").Value,
                    Ssl = false
                };
            return new(() => ConnectionMultiplexer.Connect(options));
        }
